...
if __name__ == "__main__":
    ...
    TEST_DIARY5 = "I didn't know the animal"
    diary_tags5 = tagger.tag_pos_doc(TEST_DIARY5)
    print(diary_tags5)
    print()

    TEST_DIARY4 = "The almond milk is slight sweet and nutty with no unnecessary sugar!"
    diary_tags4 = tagger.tag_pos_doc(TEST_DIARY4)
    print(diary_tags4)
    # tagger.tags_to_pickle(diary_tags4, "pickles/eliz0.pkl")
